...
{
    [BurstCompile]
    public struct TweenJob3D : IJobParallelFor
    {
        [ReadOnly] public NativeArray<Tween<float3>> Tweens;
        public NativeArray<TweenRuntimeData<float3>> TweensRuntimeData;
        public float Time;
        ...
        public void Execute(int index)
        {
            ...
            TweensRuntimeData[index] = new TweenRuntimeData<float3>(sampledValue, newPosition,TweensRuntimeData[index].CurrentLoopIndex);
            tween.Update();
        }
    }
}